...
gen.addEventListener("click", (e) => {
  ...
  certificate_box.innerHTML = `
    <div id="ccc" class="certificate-box">
                    <img
                      id="certificate"
                      src="../assets/img/Certificates/EDIT/3/3 - 1.png"
                      alt=""
                    />
                    <div class="name">${first} ${last}</div>
                    <div class="description">For an award as a workshop participant in the "${course_name}"
                    event on ${course_date}.</div>
                  </div>
                  <div class="sign">
  ...
  document.getElementById("two").addEventListener("click", () => {
    ...
    document
      ...
      .setAttribute("src", "../assets/img/Certificates/EDIT/3/3 - 2.png");
  });
  ...
  document.getElementById("three").addEventListener("click", () => {
    ...
    document
      .getElementById("certificate")
      .setAttribute("src", "../assets/img/Certificates/EDIT/3/3 - 3.png");
  });
  ...
  document.getElementById("one").addEventListener("click", () => {
    ...
    document
      .getElementById("certificate")
      .setAttribute("src", "../assets/img/Certificates/EDIT/3/3 - 1.png");
  });
});
...
document.getElementById('normal2').addEventListener('click',()=>{
  ...
  document.querySelector('.name').style.fontSize = "80px"
})
