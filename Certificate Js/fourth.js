...
gen.addEventListener("click", (e) => {
  ...
  certificate_box.innerHTML = `
    <div id="ccc" class="certificate-box">
                    <img
                      id="certificate"
                      src="../assets/img/Certificates/EDIT/4/4 - 1.png"
                      alt=""
                    />
                    <div class="name">${first} ${last}</div>
                    <div class="description">for completing their ${course_name} course in outstanding remarks on ${course_date}.</div>
                  </div>
                  <div class="sign">
  ...
  document.getElementById("two").addEventListener("click", () => {
    ...
    document
      ...
      .setAttribute("src", "../assets/img/Certificates/EDIT/4/4 - 2.png");
  });
  ...
  document.getElementById("three").addEventListener("click", () => {
    ...
    document
      .getElementById("certificate")
      .setAttribute("src", "../assets/img/Certificates/EDIT/4/4 - 3.png");
  });
  ...
  document.getElementById("one").addEventListener("click", () => {
    ...
    document
      .getElementById("certificate")
      .setAttribute("src", "../assets/img/Certificates/EDIT/4/4 - 1.png");
  });
});
...
document.getElementById('larger').addEventListener('click',()=>{
  ...
  document.querySelector('.name').style.fontSize = "107px"
})
